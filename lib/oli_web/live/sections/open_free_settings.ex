defmodule OliWeb.Sections.OpenFreeSettings do
  ...
  def render(assigns) do
    ...
    <Group label="Direct Delivery" description="Direct Delivery section settings">
      ...
      <Field name={:omit_students_email_verification} class="mt-2 form-check">
        <Checkbox class="form-check-input" value={get_field(@changeset, :omit_students_email_verification)}/>
